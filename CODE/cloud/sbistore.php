...
$str1=$_POST['bankname'];
$str2=$_POST['branchno'];
$str3=$_POST['accountholdername'];
$str4=$_POST['accountnumber'];
$str5=$_POST['accounttype'];
$str6=$_POST['ifsccode'];
$str7=$_POST['branchaddress'];
...
$encoded7 = $converter->encode($str7 );
...
$sql="INSERT INTO $btname (bankname, branchno, accountholdername, accountnumber, accounttype, ifsccode, branchaddress)
VALUES
('$encoded1', '$encoded2', '$encoded3', '$encoded4', '$encoded5', '$encoded6', '$encoded7')";
