...
<div class="article">
          ...
          <div class="clr"></div>
<h3>Stored Bank Records With Decryption:</h3>
...
while ($row = mysql_fetch_array($result, MYSQL_NUM)) {
    ...
    printf("<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>", $converter->decode($row[0]), $converter->decode($row[1]),$converter->decode($row[2]),$converter->decode($row[3]),$converter->decode($row[4]),$converter->decode($row[5]),$converter->decode($row[6]));  
}}
else
{
